...
form="act=i&kind=yanshi&jianyi1=&jianyi2=&jianyi3=&jianyi4=&jianyi5=\
...
xinyongshe38=0&jianyi38=%3Cp%3E%B0%EC%C0%ED%D2%B5%CE%F1%B2%BB%B4%ED%A3%AC%B5%D8%C3%E6%D5%FB\
...
&jianyi39=&jianyi40=&jianyi41=&jianyi42=&jianyi43=&jianyi44=&\
...
sleep 3
curl $4 -A "$ua" -D "$cookie" -b "$cookie" -o page.html -d "$form" -e "$url1" "$url"
if (( $? != 0 ))
then
    exit -1
fi
